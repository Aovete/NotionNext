...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Samuel', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普普通通的打工人,因工作原因出差在国外,了解了外汇交易.并通过一些研究分享一些交易的经验', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.for-ex.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Forex,外汇,外汇交易', // 网站关键词 英文逗号隔开
